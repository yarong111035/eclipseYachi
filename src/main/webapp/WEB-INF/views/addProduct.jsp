...
<!-- 	modelAttribute="bookBean" : 在model放屬性物件，識別字串是"bookBean"-->
<!-- 	如果沒有寫modelAttribute="bookBean" 預設名稱為 command -->
			...
			<fieldset >
				<div class="form-group">
					<label class="control-label col-lg-2 col-lg-2" for='title'>
						書名 </label>
					<div class="col-lg-10">
<!-- 						path: 呼叫BookBean 的 getTitle()，取得title 屬性 -->
				...
				<div class="form-group">
					...
					<div class='col-lg-10'>
						<form:hidden id="stock" path="stock"/>
					</div>
				</div>
