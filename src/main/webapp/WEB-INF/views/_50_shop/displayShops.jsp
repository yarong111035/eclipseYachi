  	...
  	<c:forEach var="shop" items="${shopList}">
	   ...
	   <div class="col mb-4">
	     <div class="card h-100">
	       ...
	       <img	src="<c:url value='/_50_shop/_53_shopRegister/getPicture/${shop.shop_id}'/>" class="card-img-top" alt="...">
	  	  </a>  
	       <div class="card-body">
	         <h5 class="card-title">${shop.shop_name} (${shop.nightMarketBean.market_name}) </h5>
