        ...
        <main>
            <div class="column">
                <div class="column-pic">
                    <p class="column-picname" id="menu_pic">菜單照片</p>
                </div>
                <div class="column-name">菜單名稱</div>
                <div class="column-content">菜單介紹</div>
        ...
        <c:forEach var="list" varStatus="stat" items="${shopmenu}">
            ...
            id="insert">
                <div style="width: 35%; text-align: right;">
                    ...
                    <div class="text" style="margin-top: 30px;">菜單內容：</div>
                        ...
                        <div style="display: flex;">
                            ...
                            <div>
                                ...
                                <div style="width: 100%;text-align: right;height: 60px;">
                                    <input type="submit" value="儲存" style="margin-top: 28px;width: 120px;height: 30px;    margin-right: 40px;"/>
                                </div>
                            </div>
                        </div>
                    </form:form>
            ...
            <div class="middle-bottom" 
                ...
                <button style="margin: 3px;" id="insertbtn">＋ 新增菜單</button>
                <button style="margin: 3px;" id="inputBtn">一鍵輸入</button>
            </div>
