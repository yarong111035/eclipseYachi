...
<body style="background-color: #F3F8F2;">
	...
	<div id="Board_wrap">
		<div id="Board">
			<ul>
				<li><img src="<c:url value='/getPicture/${coupon.coupon_id}'/>"
	...
	<div id="Number_wrap">
		<div id="Number" style="margin: 0px 0px 0px -94px">
			<label>使用張數</label> <input type="number" name="num" id="num">
		</div>
	</div>
	<div id="btn_wrap">
...
<%-- 		onclick="return confirmUpdate('${customerBean.customerId}');">&nbsp; --%>
<!-- 	<input type='submit' value='刪除' name='deleteBtn' -->
<%-- 		onclick="return confirmDelete('${customerBean.customerId}');"> --%>
	...
	<!-- 								</p> -->
	<!-- 				<p> -->
	<%-- 					<a href="<spring:url value='/vouchers' />" class="btn btn-default"> --%>
