...
<link rel="stylesheet" href="<c:url value='/css/_00_util/allUtil/css/normalize.css'/>">
<link rel="stylesheet" href="<c:url value='/css/_00_util/allUtil/css/header.css'/>">
</head>
<script src="<c:url value='/css/_00_util/allUtil/javascript/jquery-3.5.1.js'/>"></script>
<script src="<c:url value='/css/_00_util/allUtil/javascript/jquery-ui.js'/>"></script>
<script src="<c:url value='/css/_00_util/allUtil/javascript/header.js'/>"></script>
	...
	<header>
			...
			<div class="navbar">
				<div class="ig-links">
					<a href="#">快速登入</a> 
                     ...
                     <a href="#"><img src="<c:url value='/images/smallPic/instagram.png'/>" alt=""></a>
                     <a href="#"><img src="<c:url value='/images/smallPic/search.png'/>" alt=""></a>
				</div>
				<div class="space"></div>
				<div class="links">
		...
		<div class="search">
			<div class="search-wrap">
				...
				<div class="logo-wrap">
						<img src="<c:url value='/images/smallPic/yachiLogo50.png'/>">
				</div>
